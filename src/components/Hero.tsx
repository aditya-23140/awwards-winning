...
const Hero = () => {
  ...
  //bennettfeely.com/clippy/ -- clip path
  https: useGSAP(() => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      {isLoading && (
        <div className="flex-center absolute z-[100] h-dvh w-screen overflow-hidden glass-morp">
      ...
      >
        <div>
          <div className="mask-clip-path absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
            ...
            >
              <video
                ref={nextVideoRef}
                src={mounted ? getVideoSrc(upcomingVideoIndex) : undefined}
                loop
                muted
                id="current-video"
          ...
          <video
            ref={nextVideoRef}
            src={mounted ? getVideoSrc(currentIndex) : undefined}
            loop
            muted
            id="next-video"
        ...
        >
          G<b className="special-font-bold">a</b>ming
        </h1>
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading text-blue-100">
              redefi<b className="special-font-bold">n</b>e
            </h1>
